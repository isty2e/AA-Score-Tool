...
atom_prop_dict = {
    ...
    "LYS_C": ("NegIonizable",),
    "LEU_C": (),
    "ASP_OXT": ("NegIonizable", "Acceptor"),
    "LEU_N": ("Donor",),
    "LEU_O": ("Acceptor",),
    "PHE_CG": (),
    "SER_CB": (),
    "SER_CA": (),
    "HIS_CD2": ("PosIonizable",),
    "GLU_OE1": ("NegIonizable", "Acceptor"),
    "LYS_NZ": ("Donor", "PosIonizable"),
    "ASN_OD1": ("Acceptor",),
    "TYR_CD1": (),
    "TRP_C": (),
    "TRP_N": ("Donor",),
    "TRP_O": ("Acceptor",),
    "LEU_OXT": ("NegIonizable", "Acceptor"),
    "MET_CG": (),
    "MET_CE": (),
    "MET_CB": (),
    "MET_CA": (),
    "THR_OG1": ("Donor", "Acceptor"),
    "ALA_OXT": ("NegIonizable", "Acceptor"),
    "VAL_CG2": (),
    "VAL_CB": (),
    "VAL_CA": (),
    "VAL_C": (),
    ...
    "ASN_CA": (),
    "ASN_CG": (),
    "HIS_ND1": ("Donor", "PosIonizable", "Acceptor"),
    "ARG_CA": (),
    "MET_SD": (),
    "ARG_CD": (),
    "ARG_CG": (),
    ...
    "ASP_O": ("Acceptor",),
    "ASP_C": (),
    "ASP_OD1": ("NegIonizable", "Acceptor"),
    "ASP_OD2": ("NegIonizable", "Donor", "Acceptor"),
    "SER_OG": ("Donor", "Acceptor"),
    "TRP_NE1": ("Donor",),
    "PHE_CB": (),
    "PHE_CA": (),
    "VAL_CG1": (),
    "GLY_CA": (),
    "TRP_CH2": (),
    "TYR_OH": ("Donor", "Acceptor"),
    "ARG_OXT": ("NegIonizable", "Acceptor"),
    "THR_CB": (),
    "THR_CA": (),
    "ARG_NE": ("Donor", "PosIonizable"),
    "ILE_OXT": ("NegIonizable", "Acceptor"),
    "GLY_OXT": ("NegIonizable", "Acceptor"),
    "TRP_CZ3": (),
    "TRP_CZ2": (),
    "GLN_NE2": ("Donor",),
    "CYS_OXT": ("NegIonizable", "Acceptor"),
    "LEU_CB": (),
    "GLU_OXT": ("NegIonizable", "Acceptor"),
    "LEU_CG": (),
    "PRO_O": ("Acceptor",),
    "PRO_N": ("Donor",),
    "PRO_C": (),
    "ILE_CD1": (),
    "ASN_OXT": ("NegIonizable", "Acceptor"),
    "ARG_N": ("Donor",),
    "ARG_O": ("Acceptor",),
    "ARG_C": (),
    "ILE_CA": (),
    "ILE_CB": (),
    "ARG_NH1": ("Donor", "PosIonizable"),
    "ARG_NH2": ("Donor", "PosIonizable"),
    "ALA_O": ("Acceptor",),
    "GLN_CA": (),
    "TRP_CE2": (),
    "TRP_CE3": (),
    ...
    "GLN_CB": (),
    "GLN_OE1": ("Acceptor",),
    "TYR_OXT": ("NegIonizable", "Acceptor"),
    "LEU_CD2": (),
    "PHE_OXT": ("NegIonizable", "Acceptor"),
    "GLN_C": (),
    "GLN_O": ("Acceptor",),
    "GLN_N": ("Donor",),
    "VAL_OXT": ("NegIonizable", "Acceptor"),
    "PRO_OXT": ("NegIonizable", "Acceptor"),
    "GLU_N": ("Donor",),
    "GLU_O": ("Acceptor",),
    "LYS_CA": (),
    "LYS_CB": (),
    "HIS_CE1": ("PosIonizable",),
    "LYS_CD": (),
    "LYS_CE": (),
    "LYS_CG": (),
    "HIS_OXT": ("NegIonizable", "Acceptor"),
    "GLU_OE2": ("NegIonizable", "Donor", "Acceptor"),
    "PHE_O": ("Acceptor",),
    "PHE_N": ("Donor",),
    "PHE_C": (),
    "CYS_C": (),
    ...
    "GLU_CG": (),
    "GLU_CD": ("NegIonizable",),
    "THR_OXT": ("NegIonizable", "Acceptor"),
    "ASN_C": (),
    "HIS_CG": ("PosIonizable",),
    "HIS_CA": (),
    "HIS_CB": (),
    "LYS_OXT": ("NegIonizable", "Acceptor"),
    "LEU_CA": (),
    "ASN_N": ("Donor",),
    "ASN_O": ("Acceptor",),
    "CYS_O": ("Acceptor",),
    ...
    "PRO_CG": (),
    "PRO_CD": (),
    "TRP_OXT": ("NegIonizable", "Acceptor"),
    "HIS_NE2": ("Donor", "PosIonizable"),
    "CYS_CA": (),
    "CYS_CB": (),
    "TYR_CZ": (),
    "TYR_CG": (),
